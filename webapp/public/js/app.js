  ...
  async function renderBook() {
    ...
    document.getElementById("booking-form").addEventListener("submit", async function (e) {
      ...
      try {
        ...
        if (!res.ok) {
          ...
          msgBox.textContent = (data.errors && data.errors.join(" ")) || "Something went wrong. Please try again or WhatsApp us directly.";
        } else {
    ...
    document.getElementById("quote-form").addEventListener("submit", async function (e) {
      ...
      try {
        ...
        if (!res.ok) {
          msgBox.classList.add("show", "error");
          msgBox.textContent = (data.errors && data.errors.join(" ")) || "Something went wrong generating the quote.";
        } else {
          msgBox.classList.add("show", "success");
          const totalStr =
  ...
  async function renderContact() {
    ...
    document.getElementById("contact-form").addEventListener("submit", async function (e) {
      ...
      try {
        ...
        if (!res.ok) {
          msgBox.classList.add("show", "error");
          msgBox.textContent = (data.errors && data.errors.join(" ")) || "Something went wrong. Please try again.";
        } else {
          msgBox.classList.add("show", "success");
