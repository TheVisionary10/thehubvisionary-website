...
const { readJSON, writeJSON, cleanText, toCSV, genId, FILES, initStorage } = require("./lib/store");
    ...
    if (pathname === "/api/quote/generate" && req.method === "POST") {
      ...
      if (client.email) {
        emailResult = await sendEmail({
          ...
          attachmentBuffer: require("fs").readFileSync(path.join(__dirname, "public", record.pdfUrl)),
